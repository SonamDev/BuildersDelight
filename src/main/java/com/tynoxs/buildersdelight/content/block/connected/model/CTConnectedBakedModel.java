...
public class CTConnectedBakedModel extends CTBakedModel {
    ...
    public ModelData getModelData(@NotNull BlockAndTintGetter level, @NotNull BlockPos pos, @NotNull BlockState state, ModelData modelData) {
        ModelData.Builder _modelData = ModelData.builder();
        _modelData.with(SideData.IS_CT_BAKED_MODEL, SideData.CT_BAKED_MODEL_PREDICATE_DATA);
        for(Direction direction : Direction.values())
            _modelData.with(SideData.DIRECTION_MAPPING.get(direction), new SideData(direction, level, pos, state.getBlock(), false));
        return _modelData.build();
    }
